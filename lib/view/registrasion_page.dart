...
class _RegistrasionPageState extends State<RegistrasionPage> {
  ...
  static const List<MapEntry<String, String>> _jenisKelaminOptions =
      <MapEntry<String, String>>[
        MapEntry<String, String>('L', 'Laki-laki'),
        MapEntry<String, String>('P', 'Perempuan'),
      ];
                          ...
                          children: [
                            ...
                            _RegistrationDropdownField<TrainingOption>(
                              ...
                              items: trainings
                                  .map(
                                    (training) =>
                                        DropdownMenuItem<TrainingOption>(
                                          value: training,
                            ...
                            _RegistrationField(
                              ...
                              validator: (value) {
                                ...
                                final hasNumberOrSymbol = value.contains(
                                  RegExp(r'[\d\W_]'),
                                );
                                if (!hasUppercase ||
                                    !hasLowercase ||
                                    !hasNumberOrSymbol) {
                                  return 'Password harus ada huruf besar, kecil, dan angka/simbol.';
                                }
                                return null;
                              },
                            ),
...
class _RegistrationLoadError extends StatelessWidget {
  const _RegistrationLoadError({required this.message, required this.onRetry});
...
class _AvailableOptionsSummary extends StatelessWidget {
  const _AvailableOptionsSummary({required this.batchOptions});

  final List<BatchOption> batchOptions;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Pilih batch terlebih dahulu, lalu jurusan yang tersedia pada batch tersebut.',
